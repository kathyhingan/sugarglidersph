...
title: 'Sugar Glider Colours & Morphs: Mosaic, White & More'
...
breadcrumbs:
  ...
  - { name: 'Colours & Morphs', path: '/care-guide/sugar-glider-colours-morphs' }
faqs:
  - q: 'What is a mosaic sugar glider?'
    a: 'A mosaic is a pattern morph with irregular patches and a broken dorsal stripe, often including white markings. No two look exactly alike.'
  - q: 'Are rare sugar glider colours healthier or friendlier?'
    a: 'No. Morph affects only coat colour and pattern, not health, temperament, or how an animal bonds.'
  - q: 'What is the difference between leucistic and albino?'
    a: 'A leucistic glider is white with dark eyes; an albino is white with red eyes. The difference is in how pigment is reduced.'
  - q: 'Should I choose a sugar glider by colour?'
    a: 'Choose on temperament first, then pick the colour you love among the joeys that suit your home. Colour is the last filter, not the first.'
---
...
A mosaic is a pattern morph with irregular patches and a broken dorsal stripe, often including white markings. No two look exactly alike.

**Are rare sugar glider colours healthier or friendlier?**
No. Morph affects only coat colour and pattern, not health, temperament, or how an animal bonds.

**What is the difference between leucistic and albino?**
A leucistic glider is white with dark eyes; an albino is white with red eyes. The difference is in how pigment is reduced.

**Should I choose a sugar glider by colour?**
Choose on temperament first, then pick the colour you love among the joeys that suit your home. Colour is the last filter, not the first.

---

## Found the look and the temperament?

The best joey is the one that fits your home and happens to be a colour you love. See who is available.
